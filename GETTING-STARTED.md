...
The Greenfield project begins on Week 6 Day 1 (Monday) and ends on Week 6 Day 5 (Friday). Your project must be feature __and__ code complete by the start of the day on Week 6 Day 5 (Friday).
